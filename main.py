...
def parse_args(args):
    ...
    #
    parser.add_argument('--nb_episodes', type=int, default=10, help="Number of training episodes")
...
def main(args=None):
    ...
    summary_writer = tf.summary.FileWriter(args.type + "/tensorboard_SuperMarioBros")
    ...
    export_path = '{}/models/SuperMario'.format(args.type)
